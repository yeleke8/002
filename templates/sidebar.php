            ...
            <div class="card-body p-3">
                ...
                <div class="list-group list-group-flush bg-transparent small">
                    ...
                    <?php if($_SESSION['user_type'] === 'admin'): ?>
                        <a href="admin.php" class="list-group-item list-group-item-action bg-transparent px-0 py-2 fw-bold text-danger border-bottom">
                            <i class="fa-solid fa-user-shield me-2"></i> Админ-панель
                        </a>
                    <?php endif; ?>
